      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6"> 
        <section className="bg-gray-100 rounded-lg p-6 shadow-md"> 
          ...
          <p className="text-base">
            Full-stack front-end developer proficient in NextJS, React, Tailwind CSS, TypeScript, and Python. Passionate Bio UI/UX design, performance optimization, emerging AI tools, and 3D modeling. 
          </p>
        </section>
