...
const StickyScroll = ({ projects }: { projects: StudioCardProps[] }) => {
  ...
  return (
    <div className="max-w-[900px] rounded-xl shadow-lg">
      <motion.div
      ...
      >
        ...
        <motion.div className="hidden lg:block h-96 w-96 rounded-md shadow-lg sticky top-0 bg-slate-100/20 overflow-hidden">
